...
public class _GroupConcat extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1328098118;

    /**
     * The parameter <code>_group_concat.RETURN_VALUE</code>.
     */
     ...
     */
    public _GroupConcat() {
        super("_group_concat", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
     ...
     */
    public _GroupConcat set__1(Field<String> field) {
        setField(_1, field);
        return this;
    }
     ...
     */
    public _GroupConcat set__2(Field<String> field) {
        setField(_2, field);
        return this;
    }
}
